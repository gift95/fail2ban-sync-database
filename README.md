...
系统架构采用服务器-客户端模式，由带有令牌认证的中央 REST-API 服务器和任意数量的同步客户端组成，确保在分布式环境中的高效协同工作。Fail2BanSync 通过 AI 工具进行辅助构建和配置。 灵感来自 [davidus05] (https://github.com/davidus05/fail2ban-sync)
