...
# 3. 下载新版本的 server.py
cd /opt/fail2bansync
sudo curl -s -o server.py https://github.com/gift95/fail2ban-sync-database/raw/branch/main/Server/server.py
...
本项目采用 MIT 许可证 - 查看 [LICENSE](https://github.com/gift95/fail2ban-sync-database/src/branch/main/LICENSE) 文件了解详情。
...
3. 查看项目的 [Gitea Issues](https://github.com/gift95/fail2ban-sync-database/issues) 页面
4. 联系项目维护者获取支持
...
- **问题反馈**：[Gitea Issues](https://github.com/gift95/fail2ban-sync-database/issues)
